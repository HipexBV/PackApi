...
class MonitorDiskIo extends \HipexPackApi\Schema\BaseQuery
{
	...
	{
		$body = '';
		$body .= 'query MonitorDiskIo($applicationId: String, $startTime: String, $endTime: String) {' . PHP_EOL;
		$body .= '    MonitorDiskIo(applicationId: $applicationId, startTime: $startTime, endTime: $endTime) {' . PHP_EOL;
		$body .= '        date' . PHP_EOL;
		$body .= '        values {' . PHP_EOL;
		$body .= '            key' . PHP_EOL;
		$body .= '            value' . PHP_EOL;
