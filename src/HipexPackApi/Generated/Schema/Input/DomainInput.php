...
class DomainInput extends \HipexPackApi\Schema\BaseType implements JsonSerializable
{
	...
	{
		$this->mainPhp = $mainPhp === null ? null : (string) $mainPhp;
		return $this;
	}
	...
	{
		$this->alternativePhp = $alternativePhp === null ? null : (string) $alternativePhp;
		return $this;
	}
	...
	{
		$this->saveAccessLogs = $saveAccessLogs === null ? null : (string) $saveAccessLogs;
		return $this;
	}
